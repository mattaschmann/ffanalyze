...
rwg_cm = LinearSegmentedColormap.from_list(
    "rwg_cm",
    (
...
dark_rwg_cm = LinearSegmentedColormap.from_list(
    "dark_rwg_cm",
    (
...
cwy_cm = LinearSegmentedColormap.from_list(
    "cwy_cm",
    (
...
bwo_cm = LinearSegmentedColormap.from_list(
    "bwo_cm",
    (
